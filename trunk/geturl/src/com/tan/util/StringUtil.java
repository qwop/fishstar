...
public class StringUtil {
	...
	public final static String getWebPath(HttpServletRequest req) {
		...
		return "http://" + req.getServerName() + (80 == port ? "" : ":" + port)
				+ req.getContextPath();
	}
	...
	static String[] greets = {
			...
			"时间过了，爱情淡了，相爱的人也就散了。  ", "如果缘尽也硬要牵扯，原本的美好就会变成种束缚，变成个你我都困在其中的牢笼。  ",
			"我会无法呼吸，你舍得看到我不自由吗？  ", "云中有风，风中有我，我能有什么？  ", "云对风说，风对我说，我能对谁说？  ",
			"当窗外的风雨来了，我们有房屋，当心中的风雨来了呢？  ", "如果没有云，天空会不会寂寞？  ",
			"如果没有天空，云到哪里停泊？  ", "钢琴的爱人是手，泪的爱人是喜，爱人的爱人是一辈子，你的爱人是我。  ",
			"人生有无限的可能。  ", "我不在这里，请不要在我的坟边哭泣，因为我没有睡去。  ",
			"我是扬起千千遍遍的风，我是雪地里闪闪的白光，我是拂照在田野里的太阳，我是夜空里的星星……  ",
			"如果最亲近的人我们都无法相信，我们还怎么活下去？  ", "当我们眺望远方的时候，近处的风景便看不清了。  ",
			"快乐是一种心态，不是一种状态。  ", "有大海一样的胸怀，生活中还有什么事情会让你失去笑容呢？  ",
			"你改变不了环境，但你可以改变自己；  ", "你改变不了事实，但你可以改变态度；  ",
			"你改变不了过去，但你可以改变现在；  ", "你不能控制他人，但你可以掌握自己；  ",
			"你不能预知明天，但你可以把握今天；  ", "你不可以样样顺利，但你可以事事尽心；  ",
			"你不能延伸生命的长度，但你可以决定生命的宽度；  ", "放弃便是得到，forget it = for get it ！  ",
	...
	public static String url(final String url) {
		...
		if (type == 0) {
			return "http://www.wujieliulan.com/news.htm";
		} else if (type == 1) {
	...
	private static final DateFormat YEAR_FORMAT = new SimpleDateFormat(
			"yyyy", Locale.CHINA);
	static {
	...
	public static String greet() {
		...
		if (  /*year.equals("12")  */year.equals( year )   ) { // && (month.equals("01") ||
									// month.equals("02"))) {
		// greet = oldGetGreet();
			greet = getGreet();
		}
		...
		if (hour != null) {
			int h = Integer.parseInt(hour), m = Integer.parseInt(minute);
			if (h >= 0 && h <= 4) {
	...
	public static void main(String[] args) {
		// String encode = encode("www.wujie.net/news.htm");//
		// "ʋʋʋ˒ʋʉʖʕʙ˒ʒʙʈ˓ʒʙʋʏ˒ʔʈʑ ";
		//
