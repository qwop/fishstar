...
function entryPoint() {
	...
	/* add by qwop start.*/
	if ( path == "/otsquery/query/queryRemanentTicketAction.do") {
		/*
		...
		*/
		if (location.search == "?method=init" && document.getElementById("submitQuery")) {
			unsafeInvoke(initRemanentTicketQuery);
			//unsafeInvoke(initDirectSubmitOrder);
		}
		if (location.search == "?method=submutOrderRequest") {
			//unsafeInvoke(initSubmitOrderQuest);
...
function initTicketQuery() {
 ...
 ///////////////////////////////////////////////////// add by qwop //////////////////////////////////
	...
	function _tan() {
		...
		//__tan("_from_station_text", $("#fromStationText").val());
		//__tan("_from_station_telecode", $("#fromStation").val());

		//__tan("_to_station_text", $("#toStationText").val());
		//__tan("_to_station_telecode", $("#toStation").val());
		//__tan("_depart_date", $("#startdatepicker").val());
		//__tan("_depart_time", $("#startTime").val());

		alert( $("#fromStationText").val() + $("#fromStation").val() );
	}
	// function __tan( id, content )  { alert( id + '->' + content ); }
///////////////////////////////////////////////////// add by qwop ////////////////////////////////// 
	...
	$( "input._from" ).live("click", function () {
		...
		var TO_STATION_TEXT = '深圳'; //  utility.getPref('_to_station_text');  // 到达站名称
		var TO_STATION_TELECODE = 'SZQ'; // utility.getPref('_to_station_telecode');  // 到达站电报码
/*		
